...
/**
* Interface describing `cuanyByRight`.
*/
interface CuanyByRight {
	/**
	...
	*/
	...
	/**
	* Cumulatively tests whether at least one array element in a provided array passes a test implemented by a predicate function, while iterating from right-to-left, and assigns the results to the provided output array.
	*
	* @param x - input array
...
* var x = [ 1, 1, 0, 0, 0 ];
*
* var result = cuanyByRight( x, isPositive );
